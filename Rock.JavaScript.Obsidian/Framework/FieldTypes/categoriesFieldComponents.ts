...
export const ConfigurationComponent = defineComponent({
    ...
    setup(props, { emit }) {
        ...
        const maybeUpdateModelValue = (): boolean => {
            ...
            newValue[ConfigurationValueKey.EntityTypeName] = JSON.stringify(entityTypeName.value ?? "");
        ...
        */
        ...
        watch(() => [props.modelValue, props.configurationProperties], () => {
            entityTypeName.value = JSON.parse(props.modelValue[ConfigurationValueKey.EntityTypeName] || "{}");
        ...
        watch(entityTypeName, val => maybeUpdateConfiguration(ConfigurationValueKey.EntityTypeName, JSON.stringify(val ?? "")));
    ...
    template: `
<div>
    <EntityTypePicker label="Entity Type" v-model="entityTypeName" :multiple="false" :includeGlobalOption="false" help="The type of entity to display categories for." />
