...
namespace Rock.Blocks.Core
{
    ...
    [DisplayName( "Following Suggestion Type Detail" )]
    [Category( "Core" )]
    [Description( "Displays the details of a particular following suggestion type." )]
    ...
    public class SuggestionDetail : RockObsidianDetailBlockType
    {
        #region Keys
