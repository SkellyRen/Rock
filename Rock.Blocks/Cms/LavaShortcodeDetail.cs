...
namespace Rock.Blocks.Cms
{
    ...
    public class LavaShortcodeDetail : RockObsidianDetailBlockType
    {
        ...
        private LavaShortcodeBag GetEntityBag( LavaShortcode entity )
        {
            if ( entity == null )
            {
                return null;
            ...
            var bag = new LavaShortcodeBag
            {
                ...
                EnabledCommands = entity.EnabledLavaCommands.SplitDelimitedValues().Select( lc => new ViewModels.Utility.ListItemBag() { Text = lc, Value = lc } ).ToList(),
                Parameters = GetParameterValues( entity.Parameters )
            };
