...
.reminder-type-item-layout ^Divider {
  margin: 8, 0, 0, 0;
}
...
.filtered-reminder-card .reminders-all {
  background-color: #3f3f3f;
  color:white;
}

.filtered-reminder-card .reminders-due {
  background-color: #d9493f;
}

.filtered-reminder-card .reminders-future {
  background-color: #479ce0;
}

.filtered-reminder-card .reminders-completed {
